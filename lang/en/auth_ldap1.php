...
$string['auth_ldap1description'] = 'This method provides authentication against an external LDAP server.
...
$string['pluginname'] = 'LDAP ldap1 server';
